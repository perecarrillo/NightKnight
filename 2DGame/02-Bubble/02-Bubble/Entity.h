...
enum Animations 
{
	MOVE_LEFT, MOVE_RIGHT, STAND_LEFT, STAND_RIGHT, JUMP_LEFT, JUMP_RIGHT, DYING, NOT_PAINTED, PAINTED, MOVE_UP, LOCKED, UNLOCKING, UNLOCKED, OPENING_EMPTY, OPENED_EMPTY, OPENING_FULL, OPENED_FULL, ENTERING, TRANSFORM_TO_BAT, TRANSFORM_TO_VAMPIRE, FLY_LEFT, FLY_RIGHT
};
