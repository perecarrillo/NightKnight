...
enum Animations 
{
	MOVE_LEFT, MOVE_RIGHT, STAND_LEFT, STAND_RIGHT, JUMP_LEFT, JUMP_RIGHT, DYING, NOT_PAINTED, PAINTED, MOVE_UP, LOCKED, UNLOCKING, UNLOCKED, OPENING_EMPTY, OPENED_EMPTY, OPENING_FULL, OPENED_FULL, ENTERING, TRANSFORM_TO_BAT_RIGHT, TRANSFORM_TO_BAT_LEFT, TRANSFORM_TO_VAMPIRE_RIGHT, TRANSFORM_TO_VAMPIRE_LEFT, FLY_LEFT, FLY_RIGHT
};
