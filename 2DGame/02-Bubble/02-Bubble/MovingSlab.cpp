...
void MovingSlab::update(int deltaTime, Player *player) {
	...
	if (playerPosition.y + playerHeight >= position.y - 2.5 && playerPosition.y + playerHeight <= position.y + 2.5 && playerPosition.x < position.x + WIDTH && position.x < playerPosition.x + playerWidth)
	{
